...
import type { IdolTemplateTask } from '@/types/idolTemplate';
...
interface IdolTaskDetailModalProps {
  task: IdolTemplateTask;
  open: boolean;
  onClose: () => void;
}

export function IdolTaskDetailModal({ task, open, onClose }: IdolTaskDetailModalProps) {
